...
namespace GDI__Game
{
    public partial class Game : Form
    {
        ...
        int _tMax = 0;                                                          //
                                                                                //                                                                                //
        //Stars                                                                 //
        List<StarVar> _Stars = new List<StarVar>();                             //
        private int numStars = 300;                                             //
        private int StarRefresh = 5;                                            //
                                                                                //
        //Key Detection
        ...
        private int EnemyRefresh = 30;
        private int EnemyRefreshHolder;
        private int EnemyRefreshTick;
